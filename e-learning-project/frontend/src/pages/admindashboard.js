...
const AdminDashboard = () => {
  ...
  const sidebarItems = [
    { icon: BarChart, label: 'Reports', path: '/', active: true },
    {
      icon: Zap,
      label: 'Customization',
      path: '/admincourses',
    ...
    { icon: Users, label: 'People',  path: '/assigntask',
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 px-4">
          {sidebarItems.map((item, index) => (
            <div
              ...
              onClick={item.onClick} // Add this line to attach the onClick handler
            >
        ...
        <div className="p-4 border-t border-gray-200">
          <p className="text-sm text-gray-500 mb-4">Support</p>
          {supportItems.map((item, index) => (
            <div
              key={index}
              className="flex items-center px-4 py-3 mb-2 rounded-lg cursor-pointer text-gray-600 hover:bg-gray-50 transition-colors"
            >
              <item.icon className="w-5 h-5 mr-3" />
              <span className="font-medium">{item.label}</span>
            </div>
          ...
          <div className="mt-8 p-4 bg-gray-900 rounded-lg text-white">
            <p className="text-sm font-medium">Sam Wheeler</p>
            <p className="text-xs text-gray-300">sam@gmail.com</p>
          </div>
        </div>
      </div>
