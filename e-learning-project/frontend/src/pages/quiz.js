...
//         // Debug logging
//         console.log('🖼️ Processing question:', question.question);
//         console.log('🖼️ Raw imageUrl from backend:', question.imageUrl);
//         console.log('🖼️ imageUrl field exists?', question.hasOwnProperty('imageUrl'));
        
//         // Check if imageUrl field exists in the question
//         if (question.hasOwnProperty('imageUrl')) {
//           // imageUrl field exists
//           if (question.imageUrl === null || question.imageUrl === 'null') {
//             // If imageUrl is explicitly null or "null" string, don't show image
//             imageUrl = null;
//             console.log('🖼️ ImageUrl is null - NO IMAGE will be shown');
//           } else if (question.imageUrl && question.imageUrl.trim() !== '') {
//             // If imageUrl has a valid non-empty value, use it
//             imageUrl = question.imageUrl.trim();
//             console.log('🖼️ Using provided imageUrl:', imageUrl);
//           } else {
//             // If imageUrl is empty string, use default
//             imageUrl = "https://northfleet.in/wp-content/uploads/2024/10/Types-of-Cars-in-India.webp";
//             console.log('🖼️ Using default imageUrl (empty string case)');
//           }
//         } else {
//           // If imageUrl field doesn't exist at all, use default
//           imageUrl = "https://northfleet.in/wp-content/uploads/2024/10/Types-of-Cars-in-India.webp";
//           console.log('🖼️ Using default imageUrl (field not found)');
//         }
        
//         console.log('🖼️ Final imageUrl decision:', imageUrl);
...
//               }}
//               onError={(e) => {
//                 console.error('Failed to load image:', currentQuestionData.imageUrl);
  ...
  const fetchQuestions = async (attempt) => {
    try {
      ...
      const transformedQuestions = data.map((question, index) => {
        ...
        console.log('🖼️ Processing question:', question.question);
        console.log('🖼️ Raw imageUrl from backend:', question.imageUrl);
        console.log('🖼️ Type of imageUrl:', typeof question.imageUrl);
        console.log('🖼️ imageUrl === null:', question.imageUrl === null);
        console.log('🖼️ imageUrl === "null":', question.imageUrl === 'null');
        console.log('🖼️ imageUrl field exists?', question.hasOwnProperty('imageUrl'));
        ...
        if (question.hasOwnProperty('imageUrl')) {
          ...
          if (question.imageUrl === null || question.imageUrl === 'null') {
            ...
            imageUrl = "https://northfleet.in/wp-content/uploads/2024/10/Types-of-Cars-in-India.webp";
            console.log('🖼️ 🔄 Using default imageUrl (empty/invalid value)');
          }
        } else {
  ...
  return (
    <div className="quiz-container">
      <div className="quiz-card">
        ...
        {/* Dynamic Image Section - Enhanced Debug */}
        {currentQuestionData.imageUrl && (
          <div className="question-image-container">
            <img 
              src={currentQuestionData.imageUrl} 
              ...
              onLoad={() => {
                console.log('✅ Image loaded successfully:', currentQuestionData.imageUrl);
              }}
              onError={(e) => {
                console.error('❌ Failed to load image:', currentQuestionData.imageUrl);
            ...
            {/* <div style={{ 
              ...
              🖼️ Image URL: {currentQuestionData.imageUrl}
            </div> */}
          </div>
        )}

        {/* Debug section - Show when no image should appear */}
        {/* {!currentQuestionData.imageUrl && (
          <div style={{ 
            fontSize: '12px', 
            color: '#999', 
            ...
            🚫 No image for this question (imageUrl: {String(currentQuestionData.imageUrl)})
          </div>
        )} */}
