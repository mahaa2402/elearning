            ...
            <div className="sidebar-content">
              ...
              <div className="stats">
                <div className="stat-item">
                  <span className="stat-label">Total Courses Completed</span>
                  <span className="stat-value">{assignedTasks.filter(t => t.status === 'completed').length}</span>
                </div>
                <div className="stat-item">
                ...
                <div className="stat-item">
                  <span className="stat-label">Uncompleted Tasks</span>
                  <span className="stat-value">{assignedTasks.filter(t => t.status !== 'completed').length}</span>
                </div>
              </div>
          ...
          <main className="main-content">
            <div className="search-section">
              <div className="search-container">
                ...
                <button className="filter-btn"><Filter className="filter-icon" /></button>
                <button 
            ...
            <section className="continue-watching">
              <div className="section-header">
                ...
                <div className="section-controls">
                  <button className="control-btn"><ChevronLeft className="control-icon" /></button>
                  <button className="control-btn"><ChevronRight className="control-icon" /></button>
                </div>
              </div>
